...
// Vince Loschiavo - Edit (added lowercase check also)
void RCSwitch::sendEnd(char cChannel) {
	if ( (cChannel == 'A') || (cChannel == 'a')) {
		this->send1();
		this->send0();
		this->send0();
		this->send0();
	}
	if ((cChannel == 'B') || (cChannel == 'b')) {
		this->send0();
		this->send1();
		this->send0();
		this->send0();
	}
	if ((cChannel == 'C') || (cChannel == 'c')) {
		this->send0();
		this->send0();
		this->send1();
		this->send0();
	}
	if ((cChannel == 'D') || (cChannel == 'd')) {
		this->send0();
		this->send0();
		this->send0();
		this->send1();
